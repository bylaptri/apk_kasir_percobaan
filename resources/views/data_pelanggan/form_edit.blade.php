							...
							<div class="card-body">
								...
								<div class="pd-30 pd-sm-40 bg-gray-100">
									...
									<div class="row row-xs align-items-center mg-b-20">
										...
										<div class="col-md-8 mg-t-5 mg-md-t-0">
											<input class="form-control" value="{{ $dt->alamat }}" placeholder="Enter your Alamat" name="harga" type="text">
										</div>
									</div>
									<div class="row row-xs align-items-center mg-b-20">
										<div class="col-md-4">
										...
										<div class="col-md-8 mg-t-5 mg-md-t-0">
											<input class="form-control" value="{{ $dt->nomor_telepon }}" placeholder="Enter your Nomor Telepon" name="nomor_telepon" type="number">
										</div>
									</div>
