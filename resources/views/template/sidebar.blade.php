			...
			<div class="sticky">
				<aside class="app-sidebar sidebar-scroll">
					...
					<div class="main-sidemenu">
						...
						<ul class="side-menu ">
							<li class="slide">
								<a class="side-menu__item" href="{{ route('dashboard.index') }}"><i class="side-menu__icon fe fe-airplay"></i><span class="side-menu__label">Dashboard</span></a>
							</li>
							<li class="slide">
								...
								<ul class="slide-menu">
									...
									<li><a class="slide-item" href="{{ route('produk.index') }}">Produk</a></li>
									<li><a class="slide-item" href="{{ route('pelanggan.index') }}">Pelanggan</a></li>
									<li><a class="slide-item" href="{{ route('penjualan.index') }}">Penjualan</a></li>
									<li><a class="slide-item" href="{{ route('detailpenjualan.index') }}">Detail Penjualan</a></li>
										</ul>
									</li>
